...
|---------|------|-------|------------------------------|
| **DRE_Eventos** | `DRE_Eventos/` | Flask + React, DRE Febracis Eventos | `origin/main` — deploy final da auditoria v1.42 com health 200/db ok. Working tree: apenas `?? docs/analysis/` não rastreado. |
